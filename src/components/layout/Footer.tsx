...
export default function Footer() {
    return (
        <section className="snap-start relative w-full">
            <footer className="bg-carousel-background text-carousel-text-minimum w-full">
                ...
                <div className="max-w-7xl mx-auto px-6 py-12">
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="flex-grow lg:w-7/12">
                            <div className="flex flex-col md:flex-row md:divide-x gap-8 md:gap-0 h-full">

                                <div className="flex-1 pr-8">
                                    <h3 className="text-sm font-semibold text-carousel-text-primary mb-4 tracking-wider">
                                        PRODUCTS
                                    </h3>
                                ...
                                <div className="flex-1 md:pl-8 pr-8">
                                    <h3 className="text-sm font-semibold text-carousel-text-primary mb-4 tracking-wider">
                                        USEFUL LINKS
                                    </h3>
                                    <ul className="space-y-3">
