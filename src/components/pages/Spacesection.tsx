     ...
     return (
          <ScrollSnapSection>
               ...
               <div className="absolute max-w-7xl pt-55">
                         <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-muted leading- mb-6">
                              Space-Eyes
                         </h1>
                         <p className="text-sm md:text-xl text-muted leading-relaxed max-w-full">
