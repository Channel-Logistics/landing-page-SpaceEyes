...
const ContactUs: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-16 max-w-5xl mx-auto w-full items-start">
        <div className="flex-1 backdrop-blur-lg bg-white/10 rounded-3xl p-8 shadow-lg flex flex-col justify-between">
          <div>
            ...
            <form className="space-y-5 flex-1 flex flex-col justify-between">
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  className="w-full backdrop-blur-md bg-contact-us-fields-background placeholder-contact-us-text rounded-2xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-contact-us-border text-contact-us-text h-35"
                ></textarea>
              </div>
        ...
        <div className="flex-[0.8] h-90 md:h-[90%] backdrop-blur-lg bg-white/10 rounded-3xl p-8 shadow-lg flex flex-col justify-start border border-contact-us-border">
          <div>
            <h2 className="text-3xl font-semibold mb-10 text-contact-us-text">
              CONTACT INFO
            </h2>
            <div className="space-y-5 text-sm text-contact-us-text">
              <div>
                <p className="text-xs font-semibold mb-2 tracking-wider text-contact-us-title">
                  ADDRESS:
                </p>
                <div className="flex items-center gap-2 mb-6">
                  <MapPinCheck className="w-5 h-5 md:h-5 md:w-5" />
