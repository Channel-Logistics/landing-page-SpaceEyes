...
export default function ContactUs() {
  return (
    <div
      className="relative w-full min-h-screen text-contact-us-text px-6 pt-8 bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: "url('/images/slider/main-video.webp')" }}
    >

      <div className="max-w-7xl mx-auto mb-4 flex items-center gap-6">
      ...
      <div className="flex flex-col md:flex-row gap-20 max-w-7xl mx-auto w-full h-[80vh] items-stretch">
        ...
        <div className="flex-1 bg-contact-us-background border border-contact-us-fields-border rounded-2xl p-10 shadow-lg flex flex-col justify-between min-h-[600px]">
          <div>
            <h2 className="text-3xl font-semibold mb-12 text-contact-us-text">CONTACT INFO</h2>
